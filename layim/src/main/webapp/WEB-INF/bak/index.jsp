        ...
        init:function(){
            if ('WebSocket' in window){
                ...
                if(!uid){
                    ...
                    var socketUrl = 'ws://192.168.1.177:7777/layim/websocket/'+ uid;
    ...
    layim.config({
      ...
      init: {
         /* url: 'json/getList.json'
          //url: '/layim/api?action=base'data: {id: im.getUid()}
          , data: {id: 100000}*/
          mine: {
              "username": "游客"+uid
              ,"id": uid
...
/*
    ...
    /*
     ...
     name: '三极户外旗舰店旗舰店'
     ,type: 'kefu'
     ,avatar: 'http://seebong-hangzhou.oss-cn-hangzhou.aliyuncs.com//ShopLogoImg/200072.jpg'
     ,id: 100000
     });
