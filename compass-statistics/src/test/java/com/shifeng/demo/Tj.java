  		...
  		if(strList.size()>0){
  			for(String str:strList){
  				...
  				if(jsonobject != null){
  					...
  					sb.append("adData_visit_ad_stat_times").append("_").append(DateUtil.getYYYY_MM_DD()).append("_").append(channelurl.getCid()).append("_").append(channelurl.getId());
  	            ...
  	            long lastTime = System.currentTimeMillis();
  	          	System.out.println("time is" + (lastTime - nowTime) / 1000);
