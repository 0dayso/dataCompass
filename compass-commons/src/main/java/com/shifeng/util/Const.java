...
public class Const {
     ...
     * md5盐值字符串,用于混淆MD5
     */
	public static String MD5_SALT = "ㄎㄘㄧㄐㄊㄑㄜㄠㄘㄏㄝㄠㄣ";
	...
	// 关注店铺
	public static final String INTERFACE_FOLLOW_SHOP = "integerface:follow:shop:%s:%s";// 关注sku-userid
	// 购物车商品
	...
	//取消 退换货
	public static final String STATISTICS_COUNTY_AD_CANCEL_ORDERID_TOSAVE = "adData_county_ad_cancel_order_stat_times_%s_%s_%s";//取消 退换货订单数据--待保存数据按日期
	//key   append(statDate).append("_").append(type);
	...
	//取消 退换货
	public static final String STATISTICS_USERID_AD_CANCEL_ORDERID_TOSAVE = "adData_userid_ad_cancel_order_stat_times_%s_%s_%s";//取消 退换货订单数据--待保存数据按日期
	...
	//2016-12-21 客服系统
	//历史记录
	public static final String MSG_SC_DATE_USERID_SHOPID="msg_sc_%s_%s_%s";//历史消息（日期_用户id_商家id）
	public static final String MSG_SC_DATA = "msg_sc_data";//客服系统--消息明细待处理数据
	//2016-12-23 app下载
	public static final String APP_DOWNLOAD_DATA = "app_download_data";//app下载--明细待处理数据
	
	//2016年12月22日09:42:59
	/**
	 * 雾霾活动记录
	 */
	public static final String HUODONG_WUMAI_DATA = "huodong_wumai_data";

	/**
	 * 元旦活动记录
	 */
	public static final String HUODONG_YUANDAN_USERID="huodong_yuandan_userid_%s";//用户子弹总数
	//子弹记录
	public static final String HUODONG_YUANDAN_ZD_DATA = "huodong_yuandan_zd_data";
	//商品记录
	public static final String HUODONG_YUANDAN_SKU_DATA = "huodong_yuandan_sku_data";

	/**
	 * 接口调用返回信息key
	 */
	public static final String REQ_CODE="req_code";// 返回状态码
	public static final String REQ_MSG="req_msg";// 返回信息
