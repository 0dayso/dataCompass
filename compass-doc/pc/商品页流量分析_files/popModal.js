...
(function($) {	
	...
	open:function(s,t){var h=H[s],c=h.c,cc='.'+c.closeClass,z=(parseInt(h.w.css('z-index'))),z=(z>0)?z:3000,o=$('<div></div>').css({height:'100%',width:'100%',position:'fixed',left:0,top:0,'z-index':z-1,opacity:c.overlay/100});if(h.a)return F;h.t=t;h.a=true;h.w.css('z-index',z);
	 ...
	 h.w.css({'margin-left':-h.w.width()/2,'width':h.w.width(),'left':'50%'});
	  if (c.retrieveTop) {
			h.w.css({
				top: _top+30
			})
			...
			h.w.css({
				'top':h.w.offset().top - $(document).scrollTop()+30
			})
		}
...
jqm.confirm = function(o){
		...
		var jqmConfirm = '<div id="jqmConfirm" style="width:'+op.w+'px;" class="popModal"><h1 class="tl"><span class="tr"><span class="tit">'
						+op.title+'</span><span class="modalClose jqmClose">&#20851;&#38381;</span></span></h1><div class="moadalCon"><div class="clearfix fakeMsg '
						+op.type+'"><i class="ico"></i><div class="conText">'+op.content+'</div></div></div><div class="modalFooter pb20"><a href="javascript:void(0);"id="jqmConfirmBtn"class="btn btn-m mr25"><span>&#30830;&#23450;</span></a><a href="javascript:void(0);"id="jqmConfirmBtn"class="btn jqmClose"><span>&#21462;&#28040;</span></a></div><div class="bl"><div class="br"></div></div></div>';
...
jqm.alert= function(o){
		...
		var jqmAlert = '<div id="jqmAlert" style="width:'+op.w+'px;" class="popModal"><h1 class="tl"><span class="tr"><span class="tit">'
						+op.title+'</span><span class="modalClose '+jqmOp.closeClass+'">&#20851;&#38381;</span></span></h1><div class="moadalCon"><div class="clearfix fakeMsg '
						+op.type+'"><i class="ico"></i><div class="conText">'+op.content+'</div></div></div><div class="bl"><div class="br"></div></div></div>';
...
jqm.full= function(o){
    ...
    op.overlay = o.overlay?o.overlay:op.overlay;
    op.overlayClass = o.overlayClass?o.overlayClass:op.overlayClass;
    op.closeClass = o.closeClass?o.closeClass:op.closeClass;
    op.onHide = o.onHide?o.onHide:op.onHide;
    op.retrieveTop = o.retrieveTop?o.retrieveTop:op.retrieveTop;
    var jqmOp={
        overlay: op.overlay,
    ...
    var jqmFull = '<div id="jqmFull" style="top:0;text-align: center;margin-left: auto;margin-right: auto;width:'+screen.width+'px;height:'+screen.height+'px" class="popModal"><h1><span class="tr">'
        +'<span class="modalClose '+jqmOp.closeClass+'">&#20851;&#38381;</span></span></h1><div>'+op.content+'</div></div>';
    $('body').append(jqmFull);
    $('#jqmFull').jqm(jqmOp);
    $('#jqmFull').jqmShow();
    $('#jqmFull .'+jqmOp.closeClass+'').click(function(){
        $('#jqmFull').jqmHide().remove();
        op.onHide();
    });
}
jqm.msg= function(o){
		...
		var jqmMsg = '<div id="jqmMsg" class="popModal jqMsg '+op.type+'"style="width:'+op.w+'px;"><h3 class="jqTit"><a href=""class="modalClose '
...
jqm.popUp= function(o){
	...
	var jqmAlert = '<div id="jqmAlert" style="width:'+op.w+'px;height: 500px;" class="popModal"><h1 class="tl"><span class="tr"><span class="tit">'
					+op.title+'</span><span class="modalClose '+jqmOp.closeClass+'">&#20851;&#38381;</span></span></h1><div class="moadalCon"></div></div>';
	$('body').append(jqmAlert);
	$('#jqmAlert').jqm(jqmOp);
	$('#jqmAlert').jqmShow();
	$('#jqmAlert .'+jqmOp.closeClass+'').click(function(){
