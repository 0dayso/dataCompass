...
<body class="fixed-sidebar full-height-layout gray-bg">
    ...
    <div style="display: none;" class="middle-box text-center lockscreen animated fadeInDown">
        <div>
            <div class="m-b-md">
                <img alt="image" class="img-circle circle-border" width="212px" height="212px" src="${users.uHeadImg }">
            </div>
            <h3>${users.uName }</h3>
            <p>您需要再次输入密码</p>
	...
	<!--左侧导航结束-->
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="operate/getPeratePage.html" frameborder="0" data-id="operate/getPeratePage.html" seamless></iframe>
            </div>
            <div class="footer">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="static/img-circle message-avatar" src="">
