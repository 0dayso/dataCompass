...
<div class="wrapper wrapper-content  animated fadeInRight">
	<div class="row">
		<div id="user-box" class="col-sm-12">
			<div class="ibox">
				<form id="travels" action="message/findAllmessage.html" method="post" >
					<div class="ibox-content">
						...
						<div class="input-group">
							...
							<div class="col-md-3">
								<input type="number" placeholder="用户ID" id="userid" name="userid" value="${page.t.userid }" class="input form-control">
							</div>
							<div class="col-md-3">
							...
							<div class="col-md-3" id="status">
								<select class="form-control m-b" name="status">
									<option value="0">请选择回复类型</option>
									<option value="1" <c:if test="${page.t.status=='1'}">selected</c:if>>用户</option>
									<option value="2" <c:if test="${page.t.status=='2'}">selected</c:if>>商家</option>
								</select>
							</div>
