							...
							<div class="input-group">
								...
								<div class="col-md-3">
									<select class="form-control m-b" name="status">
										...
										<option value="1">商家保证金</option>
										<option value="2">平台使用费</option>
										<option value="3">广告费</option>
									</select>
								</div>
									...
									<table class="table">
										<tr>
											...
											<td>
												...
												<label class="checkbox-inline">
													<input type="checkbox" name="searchData.rowFields" value="9" />费用类型
												</label>
												<label class="checkbox-inline">
	...
	<script>
		...
		function searchList(urlStr) {
			if(urlStr=="" || urlStr==null){
				...
				url = "op_shop_cost_detail/findAllShopcostData.html"+"?"+$("#data").serialize()+"&&rowFieldString="+chk_value;
			}
