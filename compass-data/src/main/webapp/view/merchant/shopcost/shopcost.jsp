...
<div class="wrapper wrapper-content  animated fadeInRight">
	<div class="row">
		<div id="user-box" class="col-sm-12">
			<div class="ibox">
				<form id="travels" action="op_shop_cost_detail/findAllop_shop_cost_detail.html" method="post" >
					<div class="ibox-content">
						...
						<div class="input-group">
							...
							<div class="col-md-3">
								<input type="number" placeholder="店铺ID" id="shopId" name="shopId" value="${page.t.shopId }" class="input form-control">
							</div>
							<div class="col-md-3">
								<input type="text" placeholder="店铺名称" id="shopname" name="shopname" value="${page.t.shopname }" class="input form-control">
							</div>
							<div class="col-md-3">
							...
							<div class="col-md-3" id="channelurl">
								<select class="form-control m-b" name="status">
									...
									<option value="1" <c:if test="${page.t.status=='1'}">selected</c:if>>商家保证金</option>
									<option value="2" <c:if test="${page.t.status=='2'}">selected</c:if>>平台使用费</option>
									<option value="3" <c:if test="${page.t.status=='3'}">selected</c:if>>广告费</option>
								</select>
							</div>
