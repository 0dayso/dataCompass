...
<div class="wrapper wrapper-content  animated fadeInRight">
	<div class="row">
		<div id="user-box" class="col-sm-12">
			<div class="ibox">
				<form id="travels" action="op_cart_detail/findAllop_cart_detail.html" method="post" >
						...
						<div class="input-group">
							...
							<div class="col-md-3" id="channelurl">
								<select class="form-control m-b" name="status">
									<option value="0">请选择添加状态</option>
									<option value="1" <c:if test="${page.t.status=='1'}">selected</c:if>>加入</option>
