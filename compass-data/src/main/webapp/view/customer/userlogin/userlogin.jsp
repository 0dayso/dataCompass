...
<div class="wrapper wrapper-content  animated fadeInRight">
	<div class="row">
		<div id="user-box" class="col-sm-12">
			<div class="ibox">
				<form id="travels" action="op_login_detail/findAllop_login_detail.html" method="post" >
						...
						<div class="input-group">
							...
							<div class="col-md-3" id="channelurl">
								<select class="form-control m-b" name="status">
									<option value="0">请选择登陆状态</option>
									<option value="1" <c:if test="${page.t.status=='1'}">selected</c:if>>正常</option>
									<option value="2" <c:if test="${page.t.status=='2'}">selected</c:if>>失败</option>
								</select>
							</div>
