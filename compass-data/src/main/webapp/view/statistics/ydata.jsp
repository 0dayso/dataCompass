...
<body class="gray-bg">
									...
									<table class="table">
										<tr>
											...
											<td>
												...
												<label class="checkbox-inline">
													<input type="checkbox" name="searchData.rowFields" value="2" />渠道
												</label>
												<label class="checkbox-inline">
													<input type="checkbox" name="searchData.rowFields" value="3" />渠道链接
												</label>
												<label class="checkbox-inline">
														<input type="checkbox" name="searchData.rowFields" value="4" />店铺ID
													</label>
												<label class="checkbox-inline">
	...
	<script>
		...
		function searchList() {
			...
			var url = "op_data/findAllYop_data.html";
			jQuery.post(url+"?rowFieldString="+chk_value, $("#data").serialize(), function(response) {
