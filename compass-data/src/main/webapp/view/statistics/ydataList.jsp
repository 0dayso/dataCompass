			...
			<div class="table-responsive">
				<table class="table table-striped table-hover">
					...
					<tr>
						...
						<c:if test="${searchData.rowFieldVO.isShowShop==1 }">
							<th >店铺ID</th>
						</c:if>
					...
					<c:forEach items="${op_data}" var="list" >
						<tr>
							...
							<td>
								...
								<c:if test="${searchData.shopId!=null && searchData.shopId!='' }">
									&&shopId=${searchData.shopId}
								</c:if>
								<c:if test="${(searchData.shopId==null || searchData.shopId=='') && searchData.rowFieldVO.isShowShop==1}">
									&&shopId=${list.shopId}
								</c:if>
