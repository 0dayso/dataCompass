									...
									<table class="table">
										<tr>
											...
											<td>
												...
												<label class="checkbox-inline">
													<input type="checkbox" name="searchData.rowFields" value="7" checked="checked" />区域
												</label>
												<label class="checkbox-inline">
	...
	<script>
		...
		function searchList(urlStr) {
			if(urlStr=="" || urlStr==null){
				...
				url = "op_county_data/findAllCountyData.html"+"?"+$("#data").serialize()+"&&rowFieldString="+chk_value;
			}
