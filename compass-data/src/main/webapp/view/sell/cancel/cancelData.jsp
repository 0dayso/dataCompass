									...
									<table class="table">
										<tr>
											...
											<td>
												...
												<label class="checkbox-inline">
													<input type="checkbox" name="searchData.rowFields" value="9" />原因类型
												</label>
												<label class="checkbox-inline">
	...
	<script>
		...
		function searchList(urlStr) {
			if(urlStr=="" || urlStr==null){
				...
				url = "op_purchase_cancel_detail/findAllCancelData.html"+"?"+$("#data").serialize()+"&&rowFieldString="+chk_value;
			}
