...
public class AdDataFollowCartSpout
  implements IRichSpout
{
  private static final long serialVersionUID = -6260803932233430770L;
  private static final Logger LOG = LoggerFactory.getLogger(AdDataFollowCartSpout.class);
  ...
  public void emit() {
    try {
      ...
      try { String adDataRedis = jedis.rpop(ConfKeys.STORM_AD_FOLLOW_CART_DATA);
        if ((adDataRedis == null) || ("nil".equals(adDataRedis))) {
          ...
          Cart adVO = (Cart)JSONObject.toBean(adDataObject, Cart.class);
