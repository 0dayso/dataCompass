...
public class AdDataPurchaseSpout
  implements IRichSpout
{
  private static final long serialVersionUID = -6260803932233430770L;
  private static final Logger LOG = LoggerFactory.getLogger(AdDataPurchaseSpout.class);
  ...
  public void emit() {
    try {
      ...
      try { String adDataRedis = jedis.rpop(ConfKeys.STORM_AD_PURCHASE_DATA);
  ...
  {
    declarer.declare(new Fields(new String[] { "id", "AdPurchase" }));
  }
