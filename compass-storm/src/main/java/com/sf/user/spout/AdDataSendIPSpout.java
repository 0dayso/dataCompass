...
public class AdDataSendIPSpout
  implements IRichSpout
{
  private static final long serialVersionUID = -6260803932233430770L;
  private static final Logger LOG = LoggerFactory.getLogger(AdDataSendIPSpout.class);
  ...
  public void emit() {
    try {
      ...
      try { String adDataRedis = jedis.rpop(ConfKeys.STORM_AD_VISIT_DATA_IP);
  ...
  {
    declarer.declare(new Fields(new String[] { "id", "Adip" }));
  }
