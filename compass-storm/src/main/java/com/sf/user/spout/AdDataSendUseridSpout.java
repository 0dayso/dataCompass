...
public class AdDataSendUseridSpout
  implements IRichSpout
{
  private static final long serialVersionUID = -6260803932233430770L;
  private static final Logger LOG = LoggerFactory.getLogger(AdDataSendUseridSpout.class);
  ...
  public void emit() {
    try {
      ...
      try { String adDataRedis = jedis.rpop(ConfKeys.STORM_AD_VISIT_DATA_USERID);
  ...
  {
    declarer.declare(new Fields(new String[] { "id", "Aduserid" }));
  }
