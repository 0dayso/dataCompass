...
public class AdDataFollowSkuCountBolt
        implements IRichBolt {
    private static final long serialVersionUID = 2716006364335613235L;
    private static final Logger LOG = LoggerFactory.getLogger(AdDataFollowSkuCountBolt.class);
    ...
    public void execute(Tuple input) {
        Product adDataVO = (Product) input.getValueByField("followsku");
       ...
       //sku统计表
        ...
        sb.append("adData_follow_sku_stat_times").append("_");
       ...
       //所有sku统计表
        ...
        allsb.append("adData_follow_all_sku_stat_times").append("_");
        allsb.append(type);
        try {
            Jedis jedis = this.jedisPool.getResource();
            try {
        ...
        if(county!=null&&!county.equals("")) {
            ...
            countysb.append("adData_follow_sku_county_stat_times").append("_");
        ...
        usersb.append("adData_follow_sku_userid_stat_times").append("_");
        ...
        if ((this.dataList != null) && (this.dataList.size() >= 1)) try {
            ...
            try {
                sb = new StringBuffer();
                sb.append(ConfKeys.STATISTICS_AD_FOLLOW_SKU_DATA_DAY);
