...
public class AdDataPurchaseOrderBolt
  implements IBasicBolt
{
  private static final long serialVersionUID = -135084302785696296L;
  private static final Logger LOG = Logger.getLogger(AdDataPurchaseOrderBolt.class);
  ...
  public void execute(Tuple tuple, BasicOutputCollector collector)
  {
    ...
    if ((obj instanceof Purchase)) {
      Purchase adDataVO = (Purchase)obj;
      collector.emit("adData_purchase_order_count_stream", new Values(new Object[] { tupleId, adDataVO, adDataVO.getIp() }));
  ...
  {
    declarer.declareStream("adData_purchase_order_count_stream", new Fields(new String[] { "id", "AdPurchaseOrder", "ip" }));
