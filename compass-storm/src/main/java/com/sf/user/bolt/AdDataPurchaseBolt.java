...
public class AdDataPurchaseBolt
  implements IBasicBolt
{
  private static final long serialVersionUID = -135084302785696296L;
  private static final Logger LOG = Logger.getLogger(AdDataPurchaseBolt.class);
  ...
  public void execute(Tuple tuple, BasicOutputCollector collector)
  {
    ...
    if ((obj instanceof Purchase)) {
      ...
      collector.emit("adData_purchase_count_stream", new Values(new Object[] { tupleId, adDataVO, adDataVO.getIp() }));
  ...
  {
    declarer.declareStream("adData_purchase_count_stream", new Fields(new String[] { "id", "AdPurchase", "ip" }));
