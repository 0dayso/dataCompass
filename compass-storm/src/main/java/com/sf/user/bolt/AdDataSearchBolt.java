...
public class AdDataSearchBolt
  implements IBasicBolt
{
  private static final long serialVersionUID = -135084302785696296L;
  private static final Logger LOG = Logger.getLogger(AdDataSearchBolt.class);
  ...
  public void execute(Tuple tuple, BasicOutputCollector collector)
  {
    ...
    if ((obj instanceof Search)) {
      Search adDataVO = (Search)obj;
      collector.emit("adData_search_count_stream", new Values(new Object[] { tupleId, adDataVO, adDataVO.getIp() }));
  ...
  {
    declarer.declareStream("adData_search_count_stream", new Fields(new String[] { "id", "AdSearch", "ip" }));
