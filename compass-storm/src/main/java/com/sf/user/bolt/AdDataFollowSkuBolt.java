...
public class AdDataFollowSkuBolt
  implements IBasicBolt
{
  private static final long serialVersionUID = -135084302785696296L;
  private static final Logger LOG = Logger.getLogger(AdDataFollowSkuBolt.class);
  ...
  public void execute(Tuple tuple, BasicOutputCollector collector)
  {
    ...
    if ((obj instanceof Product)) {
      Product adDataVO = (Product)obj;
      collector.emit("adData_follow_sku_count_stream", new Values(new Object[] { tupleId, adDataVO, adDataVO.getIp() }));
  ...
  {
    declarer.declareStream("adData_follow_sku_count_stream", new Fields(new String[] { "id", "followsku", "ip" }));
