...
public class AdDataFollowShopBolt
  implements IBasicBolt
{
  private static final long serialVersionUID = -135084302785696296L;
  private static final Logger LOG = Logger.getLogger(AdDataFollowShopBolt.class);
  ...
  public void execute(Tuple tuple, BasicOutputCollector collector)
  {
    ...
    if ((obj instanceof Shop)) {
      Shop adDataVO = (Shop)obj;
      collector.emit("adData_follow_shop_count_stream", new Values(new Object[] { tupleId, adDataVO, adDataVO.getIp() }));
  ...
  {
    declarer.declareStream("adData_follow_shop_count_stream", new Fields(new String[] { "id", "followshop", "ip" }));
