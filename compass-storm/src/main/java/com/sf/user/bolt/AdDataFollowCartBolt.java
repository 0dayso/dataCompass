...
public class AdDataFollowCartBolt
  implements IBasicBolt
{
  private static final long serialVersionUID = -135084302785696296L;
  private static final Logger LOG = Logger.getLogger(AdDataFollowCartBolt.class);
  ...
  public void execute(Tuple tuple, BasicOutputCollector collector)
  {
    ...
    if ((obj instanceof Cart)) {
      Cart adDataVO = (Cart)obj;
      collector.emit("adData_follow_cart_count_stream", new Values(new Object[] { tupleId, adDataVO, adDataVO.getIp() }));
  ...
  {
    declarer.declareStream("adData_follow_cart_count_stream", new Fields(new String[] { "id", "followcart", "ip" }));
