...
public class AdDataSendCountBolt
        implements IRichBolt {
    private static final long serialVersionUID = 2716006364335613235L;
    private static final Logger LOG = LoggerFactory.getLogger(AdDataSendCountBolt.class);
    ...
    public void execute(Tuple input) {
        Visit adDataVO = (Visit) input.getValueByField("AdVisit");
        ...
        sb.append("adData_visit_ad_stat_times").append("_");
        ...
        if(sku!=null&&!sku.equals("")) {
            ...
            skusb.append("adData_visit_sku_ad_stat_times").append("_");
        ...
        if(county!=null&&!county.equals("")) {
            ...
            countysb.append("adData_visit_county_ad_stat_times").append("_");
        ...
        if(userid!=null&&userid!=0) {
            ...
            usersb.append("adData_visit_userid_ad_stat_times").append("_");
        ...
        if ((this.dataList != null) && (this.dataList.size() >= 1)) try {
            ...
            try {
                sb = new StringBuffer();
                sb.append(ConfKeys.STATISTICS_AD_VISIT_DATA_DAY);
