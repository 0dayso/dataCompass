...
public class AdDataSendUsercookieBolt
  implements IBasicBolt
{
  private static final long serialVersionUID = -135084302785696296L;
  private static final Logger LOG = Logger.getLogger(AdDataSendUsercookieBolt.class);
  ...
  public void execute(Tuple tuple, BasicOutputCollector collector)
  {
    ...
    if ((obj instanceof Visit)) {
      ...
      collector.emit("adData_send_cookie_count_stream", new Values(new Object[] { tupleId, adDataVO, adDataVO.getCookieid() }));
  ...
  {
    declarer.declareStream("adData_send_cookie_count_stream", new Fields(new String[] { "id", "Adcookie", "cookie" }));
