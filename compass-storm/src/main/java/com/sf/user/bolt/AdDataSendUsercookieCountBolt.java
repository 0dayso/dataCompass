...
public class AdDataSendUsercookieCountBolt
        implements IRichBolt {
    private static final long serialVersionUID = 2716006364335613235L;
    private static final Logger LOG = LoggerFactory.getLogger(AdDataSendUsercookieCountBolt.class);
    ...
    public void execute(Tuple input) {
        Visit adDataVO = (Visit) input.getValueByField("Adcookie");
        ...
        sb.append("adData_visit_ad_cookie_stat_times").append("_");
        ...
        if(sku!=null&&!sku.equals("")) {
            ...
            skusb.append("adData_visit_sku_ad_cookie_stat_times").append("_");
        ...
        if(county!=null&&!county.equals("")) {
            ...
            countysb.append("adData_visit_county_ad_cookie_stat_times").append("_");
        ...
        if(userid!=null&&userid!=0) {
            ...
            usersb.append("adData_visit_userid_ad_cookie_stat_times").append("_");
