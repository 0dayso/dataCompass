...
public class AdDataSendIPCountBolt
        implements IRichBolt {
    private static final long serialVersionUID = 2716006364335613235L;
    private static final Logger LOG = LoggerFactory.getLogger(AdDataSendIPCountBolt.class);
    ...
    public void execute(Tuple input) {
        Visit adDataVO = (Visit) input.getValueByField("Adip");
       ...
       //统计表
        ...
        sb.append("adData_visit_ad_ip_stat_times").append("_");
        ...
        if(sku!=null&&!sku.equals("")) {
            ...
            skusb.append("adData_visit_sku_ad_ip_stat_times").append("_");
        ...
        if(county!=null&&!county.equals("")) {
            ...
            countysb.append("adData_visit_county_ad_ip_stat_times").append("_");
        ...
        if(userid!=null&&userid!=0) {
            ...
            usersb.append("adData_visit_userid_ad_ip_stat_times").append("_");
